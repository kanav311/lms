...
function aiipltech_pay(){
  ...
  $data = [];
    ...
    $data['furl'] = route('cart.method',['code'=>$code,'function'=>'aiipltech_failure']);
    $data['curl'] = route('cart.method',['code'=>$code,'function'=>'aiipltech_failure']);
    $key          =  trim($key);
