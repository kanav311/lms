            ...
            if($page->type =='l'){
                ...
                if(saas()  && defined('USER_ID')){
                    ...
                    try {
                        ...
                        if(!isaiipltechSubdomain() && defined('BASE_DOMAIN_NAME') && !empty(BASE_DOMAIN_NAME)){
                        ...
                        //$resourceKey = 'http://vcdn.aiipltech.net/*';
                        ...
                        foreach ($signedCookieCannedPolicy as $name => $value) {
                            ...
                            //  setrawcookie($name, $value, time() + (86400 * 30), "/",'aiipltech.net', false, false); // 86400 = 1 day
